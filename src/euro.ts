...
const Now: string = 'https://economia.awesomeapi.com.br/last/EUR-BRL'
...
function renderCotaNow(data: APINow){
  ...
  console.log(data.EURBRL.name)
  
  name.innerHTML = data.EURBRL.name
  now.innerHTML = data.EURBRL.bid
  temp.innerHTML = data.EURBRL.create_date
}

const lastDays: string = 'https://economia.awesomeapi.com.br/json/daily/EUR-BRL/30'
